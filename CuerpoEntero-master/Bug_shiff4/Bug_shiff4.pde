...
fullScreen();
  ...
  myRemoteLocation = new NetAddress("192.168.25.165", 12500);
  ...
  soundfile1 = new SoundFile(this, "data/InsectosNivel3.wav");
...
void draw() {
  ...
  mouse.x= map(mouse.x, 110, 560, 0, resX);
  mouse.y= map(mouse.y, 150, 430, resY, 0);
